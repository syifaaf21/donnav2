<ul class="space-y-1 py-4">
    ...
    <li>
        ...
        {{ request()->is('dashboard*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
    ...
    <li>
        <a href="{{ route('document-control.index') }}" data-bs-title="Document Control"
            class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 transition-all
        {{ Route::is('document-control*') ? 'bg-matcha shadow-inner text-blue-900 fw-bold' : 'text-gray-700' }}">
    ...
    <li>
        <a href="{{ route('document-review.index') }}" data-bs-title="Document Review"
            class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 transition-all
        {{ Route::is('document-review*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
    ...
    <li>
        <a href="{{ route('ftpp.index') }}" data-bs-title="FTPP"
            class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 transition-all
            {{ Route::is('ftpp*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
    ...
    @if (in_array(strtolower(auth()->user()->roles->pluck('name')->first() ?? ''), ['super admin', 'admin']))
        <li>
            <a data-bs-title="Master Data"
                ...
                {{ Route::is('master*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}"
            ...
            <ul id="masterDataMenu" class="ml-2 mt-1 hidden space-y-1">
                ...
                <li>
                    <a href="{{ route('master.departments.index') }}" data-bs-title="Department"
                        ...
                        {{ Route::is('master.departments.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.products.index') }}" data-bs-title="Product"
                        class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.products.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.models.index') }}"
                        class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.models.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.processes.index') }}" data-bs-title="Process"
                        class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.processes.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.part_numbers.index') }}" data-bs-title="Part Number"
                        class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.part_numbers.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                        <i data-feather="box" class="menu-icon w-5 h-5"></i>
                ...
                <li>
                    <a href="{{ route('master.hierarchy.index') }}" data-bs-title="Hierarchy"
                        class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.hierarchy.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a type="button" data-bs-title="Document"
                        class="collapse-toggle menu-item w-full flex items-center justify-between px-2 py-3 rounded-l-full hover:bg-gray-200 text-left font-medium
                        {{ Route::is('master.document*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}"
                    ...
                    <ul id="documentsDropdown" class="ml-2 mt-1 hidden space-y-1">
                        <li>
                            <a href="{{ route('master.document-control.index') }}" data-bs-title="Document Control"
                                class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                                {{ Route::is('master.document-control.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                                <i data-feather="settings" class="menu-icon w-5 h-5"></i>
                        ...
                        <li>
                            <a href="{{ route('master.document-review.index2') }}" data-bs-title="Document Review"
                                class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                                {{ Route::is('master.document-review.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.ftpp.index') }}" data-bs-title="FTPP"
                        class="menu-item flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm {{ Route::is('master.ftpp.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.users.index') }}" data-bs-title="User"
                        class="flex items-center gap-3 px-2 py-3 rounded-l-full hover:bg-gray-200 text-sm
                            {{ Route::is('users.*') ? 'bg-matcha shadow-inner text-gray-700' : 'text-gray-700' }}">

    ...
    @if (in_array(strtolower(auth()->user()->roles->pluck('name')->first() ?? ''), ['super admin', 'admin']))
        <li>
            <a href="{{ route('archive.index') }}" data-bs-title="Archive"
                class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200
                {{ Route::is('archive*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
    ...
    @if (in_array(strtolower(auth()->user()->roles->pluck('name')->first() ?? ''), ['super admin', 'admin']))
        <li>
            <a data-bs-title="Master Data"
                ...
                {{ Route::is('master*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}"
            ...
            <ul id="masterDataMenu" class="ml-2 mt-1 hidden">
                ...
                <li>
                    <a href="{{ route('master.departments.index') }}" data-bs-title="Department"
                        ...
                        {{ Route::is('master.departments.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a href="{{ route('master.products.index') }}" data-bs-title="Product"
                        class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.products.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a href="{{ route('master.models.index') }}"
                        class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.models.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a href="{{ route('master.processes.index') }}" data-bs-title="Process"
                        class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.processes.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a href="{{ route('master.part_numbers.index') }}" data-bs-title="Part Number"
                        class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.part_numbers.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                        <i data-feather="box" class="menu-icon w-4 h-4"></i>
                ...
                <li>
                    <a href="{{ route('master.hierarchy.index') }}" data-bs-title="Hierarchy"
                        class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                        {{ Route::is('master.hierarchy.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a type="button" data-bs-title="Document"
                        ...
                        {{ Route::is('master.document*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}"
                    ...
                    <ul id="documentsDropdown" class="ml-2 mt-1 hidden space-y-1">
                        <li>
                            <a href="{{ route('master.document-control.index') }}" data-bs-title="Document Control"
                                class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                                {{ Route::is('master.document-control.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                                <i data-feather="settings" class="menu-icon w-4 h-4"></i>
                        ...
                        <li>
                            <a href="{{ route('master.document-review.index2') }}" data-bs-title="Document Review"
                                class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                                {{ Route::is('master.document-review.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a href="{{ route('master.ftpp.index') }}" data-bs-title="FTPP"
                        class="menu-item flex text-sm items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm {{ Route::is('master.ftpp.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">
                ...
                <li>
                    <a href="{{ route('master.users.index') }}" data-bs-title="User"
                        class="flex items-center gap-3 px-2 py-[10px] rounded-l-full hover:bg-gray-200 text-sm
                            {{ Route::is('users.*') ? 'bg-gradient-to-r from-primaryDark to-primaryLight shadow-md text-white font-medium' : 'text-gray-700 hover:text-gray-900' }}">

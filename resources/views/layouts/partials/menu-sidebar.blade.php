<ul class="space-y-1 px-2 py-4">
    ...
    <li>
        ...
        {{ request()->is('/') ? 'bg-matcha text-gray-100' : 'text-gray-700' }}">
    ...
    <li>
        <a href="{{ route('document-control.index') }}"
            class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 transition-all
        {{ Route::is('document-control*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
            <i data-feather="settings" class="menu-icon w-4 h-4 text-gray-700"></i>
    ...
    <li>
        <a href="{{ route('document-review.index') }}"
            class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 transition-all
        {{ Route::is('document-review*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
    ...
    <li>
        <a href="{{ route('ftpp.index') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 transition-all {{ Route::is('ftpp*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
    ...
    @if (in_array(strtolower(auth()->user()->roles->pluck('name')->first() ?? ''), ['super admin', 'admin']))
        <li>
            <a type="button"
                class="collapse-toggle menu-item w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-gray-200 text-left font-medium"
            ...
            <ul id="masterDataMenu" class="ml-2 mt-1 hidden space-y-1">
                ...
                <li>
                    <a href="{{ route('master.departments.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                        {{ Route::is('master.departments.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.products.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                        {{ Route::is('master.products.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.models.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                        {{ Route::is('master.models.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.processes.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                        {{ Route::is('master.processes.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.part_numbers.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                        {{ Route::is('master.part_numbers.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                        <i data-feather="box" class="menu-icon w-4 h-4"></i>
                ...
                <li>
                    <a href="{{ route('master.hierarchy.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                        {{ Route::is('master.hierarchy.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                    ...
                    <ul id="documentsDropdown" class="ml-2 mt-1 hidden space-y-1">
                        <li>
                            <a href="{{ route('master.document-control.index') }}"
                                class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                                {{ Route::is('master.document-control.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                        ...
                        <li>
                            <a href="{{ route('master.document-review.index2') }}"
                                class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                                {{ Route::is('master.document-review.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.ftpp.index') }}"
                        class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm {{ Route::is('master.ftpp.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">
                ...
                <li>
                    <a href="{{ route('master.users.index') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-200 text-sm
                            {{ Route::is('users.*') ? 'bg-matcha text-gray-700' : 'text-gray-700' }}">

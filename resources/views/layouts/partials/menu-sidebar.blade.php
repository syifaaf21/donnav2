<ul class="space-y-1 px-2">
            ...
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-all {{ request()->is('/') ? 'bg-gray-100 font-semibold text-blue-600' : '' }}">
            ...
            <li>
                <a href="{{ route('document-control.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-all {{ Route::is('document-control*') ? 'bg-gray-100 font-semibold text-blue-600' : '' }}">
            ...
            <li>
                <a href="{{ route('document-review.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-all {{ Route::is('document-review*') ? 'bg-gray-100 font-semibold text-blue-600' : '' }}">
                ...
                <ul id="masterDataMenu" class="ml-6 mt-1 hidden space-y-1">
                    <li>
                        <a href="{{ route('master.users.index') }}"
                            class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-sm {{ Route::is('users.*') ? 'bg-blue-100 text-blue-600' : 'text-gray-600' }}">
                    ...
                    <li>
                        <a href="{{ route('master.part_numbers.index') }}"
                            class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-sm {{ Route::is('part_numbers.*') ? 'bg-blue-100 text-blue-600' : 'text-gray-600' }}">
                    ...
                    <li>
                        <a href="{{ route('master.hierarchy.index') }}"
                            class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-sm {{ Route::is('hierarchy.*') ? 'bg-blue-100 text-blue-600' : 'text-gray-600' }}">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <div class="flex items-center gap-3">
                                <i data-feather="file-text" class="w-5 h-5 text-pink-500"></i>
                        ...
                        <ul id="documentsDropdown" class="ml-6 mt-1 hidden space-y-1">
                            <li>
                                <a href="{{ route('master.document-control.index') }}"
                                    class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-sm {{ Route::is('document-control.*') ? 'bg-blue-100 text-blue-600' : 'text-gray-600' }}">
                            ...
                            <li>
                                <a href="{{ route('master.document-review.index') }}"
                                    class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-sm {{ Route::is('document-review.*') ? 'bg-blue-100 text-blue-600' : 'text-gray-600' }}">

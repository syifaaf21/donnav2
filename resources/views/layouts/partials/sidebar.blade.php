    ...
    <div class="flex items-center justify-between px-3 py-2">
        <div class="flex items-center gap-2">
            <img src="{{ asset('images/madonna.png') }}" alt="Logo" id="sidebarLogo"
                style="width: 100px; height: auto;" class="object-contain transition-all duration-300"
        ...
        <div class="flex items-center gap-2">
            <button id="openSidebarBtn" type="button"
                class="flex items-center justify-center w-8 h-8 bg-white/50 border border-white rounded-md hover:bg-gray-100 transition-colors text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-500"

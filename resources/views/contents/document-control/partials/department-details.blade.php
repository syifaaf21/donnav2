                        ...
                        <div class="overflow-x-auto overflow-y-auto max-h-[520px]">
                            <table class="min-w-full divide-y divide-gray-200 ">
                                <thead class="sticky top-0 z-10" style="background: #f3f6ff; border-bottom: 2px solid #e0e7ff;">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-sm font-bold uppercase tracking-wider" style="color: #1e2b50; letter-spacing: 0.5px;">No
                                        </th>
                                    ...
                                    @else
                                        @foreach ($mappings as $mapping)
                                            <tr class="hover:bg-gray-50 transition-all duration-150">
                                                ...
                                                <td class="px-4 py-2 text-sm truncate ext-sm font-semibold max-w-xs"
                                                ...
                                                <td class="px-4 py-3 ext-sm font-semibold">
                                                ...
                                                <td class="px-4 py-2 text-center">
                                                    <div class="flex justify-start items-center gap-2 flex-wrap">
                                                        ...
                                                        @php
                                                            ...
                                                            )->filter(fn($file) => ($file['is_active'] ?? 0) == 1);
                                                        @endphp

                                                        @if ($filesToShow->count() > 1)
                                                            <div class="relative">
                                                                <!-- Dropdown toggle button -->
                                                                <button id="viewFilesBtn-{{ $mapping->id }}"
                                                                    type="button"

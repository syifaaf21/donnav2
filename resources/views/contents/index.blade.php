    ...
    <div class="my-3">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-8 d-flex">
                <div class="card shadow-sm border-0 w-100 rounded-3">
                    <div class="card-body p-3">
                        <!-- Header -->
                        <div class="fw-bold mb-3 d-flex align-items-center gap-2">
                            ...
                            <span class="h6 mb-0 text-dark">Obsolete Documents</span>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderless align-middle text-center mb-0">
                                <thead class="table-light rounded-top">
                                    <tr>
                                        <th class="small text-uppercase text-muted">Document Name</th>
                                        <th class="small text-uppercase text-muted">Department</th>
                                        <th class="small text-uppercase text-muted">Obsoleted At</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($obsoleteDocuments as $doc)
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-danger bg-opacity-75 text-white px-2 py-1 rounded-pill">
                                                    {{ $doc->department->name ?? '-' }}
                                                </span>
                                            </td>
                                            <td class="small">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-muted small py-3">No obsolete documents found.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>

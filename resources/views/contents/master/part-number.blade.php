...
<div class="container">
    ...
    <!-- Tombol Add -->
    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addModal">Tambah Part Number</button>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button
                            ...
                            data-product_id="{{ $part->product_id }}"
                            data-model_id="{{ $part->model_id }}"
                            data-process="{{ $part->process }}"
                        >Edit</button>

                        <form action="{{ route('part_numbers.destroy', $part->id) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Yakin hapus data ini?')">
                            @csrf
                            @method('DELETE')

...
@endsection
@section('content')
    <div class="mx-auto px-4 py-2 bg-white rounded-lg shadow mt-4">
        {{-- Header --}}
            ...
            <div class="py-3 mt-2 text-white">
                <div class="mb-2 text-white">
                    ...
                    <p class="text-sm" style="font-size: 0.85rem;">
                        Manage product records. Use the "Add Product" button to create new entries and the actions
                ...
                <div
                    ...
                    <table class="min-w-full text-sm text-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-200"
                            @forelse ($products as $product) <tr class="hover:bg-gray-50 transition-all duration-150">
                                    <td class="px-4 py-3 border-r border-gray-200">
                                        {{ ($products->currentPage() - 1) * $products->perPage() + $loop->iteration }}
                                    </td>
                                    <td class="px-4 py-3 text-sm font-semibold border-r border-gray-200">{{ ucwords($product->name) }}</td>
                                    <td class="px-4 py-3 border-r border-gray-200">{{ $product->code }}</td>
                                    <td class="px-4 py-3 border-r border-gray-200">{{ $product->plant }}</td>

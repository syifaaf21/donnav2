        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm text-left text-gray-600">
            ...
            @forelse ($users as $user)
                ...
                <td class="px-4 py-3 align-top whitespace-nowrap">
                    ...
                    <button type="button"
                        class="btn-edit-user bg-yellow-500 hover:bg-yellow-600 text-white p-2 rounded transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-300"
                    ...
                    @if (in_array(auth()->user()->roles->pluck('name')->first(), ['Admin', 'Super Admin']))
                        ...
                        @method('DELETE')
                        <button type="submit"
                            class="bg-red-600 text-white hover:bg-red-700 p-2 rounded focus:outline-none focus:ring-2 focus:ring-red-300"
